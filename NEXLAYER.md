...
**Live:** [https://relaxed-weasel-huly-web.cloud.nexlayer.ai](https://relaxed-weasel-huly-web.cloud.nexlayer.ai)  
...
**huly-web** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
    - name: app
      image: "registry.nexlayer.io/user_01kece1xyh817dwff7wnarhkxd/huly-selfhost:9f1ffa5-fix5"
      path: /
      servicePorts:
        - 80
      vars: {}
